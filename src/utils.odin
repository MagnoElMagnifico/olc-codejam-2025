// Wraps os.read_entire_file and os.write_entire_file, but they also work with
// emscripten.
//
// Unused of this application, but keep here as reference.
#+build ignore
package game
...
when ODIN_ARCH_STRING == "wams32" || ODIN_ARCH_STRING == "wasm64p32" {
	// Implementations of `read_entire_file` and `write_entire_file` using the
	// libc stuff emscripten exposes. You can read the files that get bundled by
